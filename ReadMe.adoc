...
![Smart Trash Bin Physical Setup](./Images/PhysicalSetup.jpg)

### Figure 2 – Design Inspiration (WALL·E)  
![WALL·E Inspired Look](./Images/wall-e.jpg)

### Figure 3 – Arduino IoT Cloud Dashboard  
![Cloud Dashboard](./Images/ArduinoCloudDashboard.png)

### Figure 4 – Mobile Dashboard View  
![Mobile Dashboard](./Images/ArduinoDashBoardMobile.jpg)
